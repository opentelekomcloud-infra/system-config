...
port=9000
status_url=https://zuul.otc-service.com
root=https://zuul.otc-service.com
prometheus_port=9091
...
dburi=postgresql://{{ .Data.username }}:{{ .Data.password }}@192.168.21.246:5432/zuul?sslmode=require
{{- end }}
